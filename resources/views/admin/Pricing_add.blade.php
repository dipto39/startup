        ...
        <form action="{{ url($url) }}" method="POST" class="p-5" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="mb-3 ">
                    ...
                    <input type="text" name="name" class="form-control" value="{{(isset($pricingData)) ? $pricingData['pname'] : ""}}">
                </div>
                <div class="mb-3 ">
                    <label for="exampleInputName1" class="form-label"> Prising Title </label>
                    <input type="text" name="ptitle" class="form-control" value="{{(isset($pricingData)) ? $pricingData['title'] : ""}}">
                </div>
                <div class="mb-3 ">
                    <label for="exampleInputName1" class="form-label">Cost</label>
                    <input type="number" name="cost" class="form-control" value="{{(isset($pricingData)) ? $pricingData['amount'] : ""}}">
                </div>
                <div class="">
