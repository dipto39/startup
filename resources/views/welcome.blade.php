        ...
        <div class="carousel-inner">
            @if (count($carousel) > 0)
                ...
                <div class="carousel-item active">
                    <img class="w-100" src="{{ asset($item['img']) }}" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-3 animated slideInDown">{{$item['h1']}}</h5>
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn">{{$item['h2']}}</h1>
                        ...
                        <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
                            <div class="bg-light rounded">
                                <div class="border-bottom py-4 px-5 mb-4">
                                    <h4 class="text-primary mb-1">{{ $item['pname'] }}</h4>
                                    <small class="text-uppercase">{{ $item['title'] }}</small>
                                </div>
                                <div class="p-5 pt-0">
                                    <h1 class="display-5 mb-3">
                                        <small class="align-top"
                                            style="font-size: 22px; line-height: 45px;">$</small>{{ $item['amount'] }}.00<small
                                            class="align-bottom" style="font-size: 16px; line-height: 40px;">/
                                            Month</small>
                                    </h1>
                                    <div class="d-flex justify-content-between mb-3"><span>HTML5 & CSS3</span>
                                        @if (!empty($item['html']))
                                    ...
                                    <div class="d-flex justify-content-between mb-3"><span>Bootstrap v5</span>
                                        @if (!empty($item['boot']))
                                            <i class="fa fa-check text-primary pt-1"></i>
                                        @else
                                            <i class="fa fa-times text-danger pt-1"></i>
                                    ...
                                    <div class="d-flex justify-content-between mb-3"><span>Responsive Layout</span>
                                        @if (!empty($item['res']))
                                            <i class="fa fa-check text-primary pt-1"></i>
                                        @else
                                            <i class="fa fa-times text-danger pt-1"></i>
                    ...
                    <div class="bg-primary rounded h-100 d-flex align-items-center p-5 wow zoomIn" data-wow-delay="0.9s">
                        <form action="{{ route('appointment.store') }}" method="post">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <textarea name='message' class="form-control bg-light border-0" rows="3" placeholder="Message">{{ old('message') }}</textarea>
                                </div>
                                <div class="col-12">
                    ...
                    @foreach ($claint as $item)
                        <div class="testimonial-item bg-light my-4">
                            <div class="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                                <img class="img-fluid rounded" src="{{ asset($item['img']) }}"
                                    style="width: 60px; height: 60px;">
                                <div class="ps-4">
                                    <h4 class="text-primary mb-1">{{ $item['name'] }}</h4>
                                    <small class="text-uppercase">{{ $item['pro'] }}</small>
                                </div>
                            </div>
                            ...
                            <div class="team-item bg-light rounded overflow-hidden">
                                <div class="team-img position-relative overflow-hidden">
                                    ...
                                    <div class="team-social">
                                        ...
                                        @if ($item['tw'])
                                            <a class="btn btn-lg btn-primary btn-lg-square rounded"
                                                href="{{ $item['tw'] }}"><i class="fab fa-twitter fw-normal"></i></a>
                                        @endif
                                        @if ($item['in'])
                                            <a class="btn btn-lg btn-primary btn-lg-square rounded"
                                                href="{{ $item['in'] }}"><i class="fab fa-instagram fw-normal"></i></a>
                                        @endif
                                        @if ($item['li'])
                                            <a class="btn btn-lg btn-primary btn-lg-square rounded"
                                                href="{{ $item['li'] }}"><i
                                ...
                                <div class="text-center py-4">
                                    ...
                                    <p class="text-uppercase m-0">{{ $item['desi'] }}</p>
                                </div>
                            </div>
                        </div>
                    @endforeach
                        ...
                        <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                            <div class="blog-item bg-light rounded overflow-hidden">
                                <div class="blog-img position-relative overflow-hidden" style="height:300px">
                                    <img class="h-100 w-100" src="{{ asset($item['img']) }}" alt="">
                                    <a class="position-absolute top-0 start-0 bg-primary text-white rounded-end mt-5 py-2 px-4"
                                        href="">{{ $item['cata'] == 1 ? 'Web Design' : 'Web Development' }}</a>
                                </div>
                                <div class="p-4">
                                    <div class="d-flex mb-3">
                                        <small class="me-3"><i
                                                class="far fa-user text-primary me-2"></i>{{ $item['auth'] }}</small>
                                        <small><i
                                                class="far fa-calendar-alt text-primary me-2"></i>{{ date('d M, Y', strtotime($item['created_at'])) }}</small>
                                    </div>
                                    <h4 class="mb-3">{{ $item['title'] }}</h4>
                                    <p>{{ substr($item['details'], 0, 50) }}</p>
